...
class SparseMolecularDataset():
    ...
    def _generate_encoders_decoders(self):
        ...
        self.log('Created atoms encoder and decoder with {} atom types and 1 PAD symbol!'.format(self.atom_num_types - 1))
    ...
    def matrices2mol(self, node_labels, edge_labels, strict=False):
        ...
        for node_label in node_labels:
            for nd_ in node_label:
                for i in list(nd_):
                    mol.AddAtom(Chem.Atom(self.atom_decoder_m[i]))
